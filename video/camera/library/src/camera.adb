...
-- use type Ada_Lib.Options.Video_Lib_Nested_Options_Type;
...
--       " help test " & Ada_Lib.Options.Nested_Options.Help_Test'img);
      ...
      if Ada_Lib.Options.Has_Option (Option, Options_With_Parameters,
         ...
         return Log_Out (Video.Lib.Video_Lib_Nested_Options_Type (Options).Process_Option (
               Iterator, Option),
            Debug or Trace_Options,
            Option.Image & " handled");
      else
         return Log_Out (
            Video.Lib.Video_Lib_Nested_Options_Type (
